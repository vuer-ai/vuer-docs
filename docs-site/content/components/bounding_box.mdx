...
section: "Components"
order: 24
description: "Bounding Box — Vuer documentation"
---
...
<Callout>
  **Performance Tip**
  ...
  When rendering multiple `BoundingBox` instances, wrap them in a `BoundingBoxProvider` for better performance. The provider enables instanced rendering with shared shader material and geometry.
</Callout>
