...
section: "Components"
order: 26
description: "CameraView — Vuer documentation"
---
...
The `CameraView` component creates a virtual camera in your scene that can render images from arbitrary viewpoints. This is essential for:
