...
section: "Components"
order: 39
description: "Frustum — Vuer documentation"
---
...
<DocImage src="/source/components/figures/frustum.jpg" alt="" />
...
- [Spline Frustum](/examples/spline_frustum) - Animated camera paths
