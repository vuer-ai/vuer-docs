...
section: "Components"
order: 45
description: "ImageBackground — Vuer documentation"
---
...
<DocImage src="/source/components/figures/3D_movie.png" alt="Side view of the 3D movie screen" />
...
<Callout>
  **ImagePlane.layer Property**
  ...
  Pay attention to the layer property. You can set it to 3 to have it show up in both eyes! layers=0 is the default, and it appears on all of the cameras.
</Callout>
...
- [Depth Image](/examples/background/depth_image) - Depth-aware backgrounds
- [VR HUD](/examples/background/vr_hud) - Stereo image backgrounds
