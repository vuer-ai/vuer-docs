...
section: "Components"
order: 49
description: "LumaSplats — Vuer documentation"
---
...
With this example, you should expect to see a scene that looks like the following: <DocImage src="/source/components/figures/robot_no_background.png" alt="3d gaussian splat: Robot (no background)" /> <DocImage src="/source/components/figures/robot.png" alt="3d gaussian splat: Robot (w/ background)" />

## Basic Example

This example shows how to load a Gaussian splat from Luma AI. You can use either a `Luma AI URL` directly or an exported file.
