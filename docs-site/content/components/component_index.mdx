---
title: "3.1.2 Vuer Component Index"
section: "Components"
order: 37
description: "3.1.2 Vuer Component Index — Vuer documentation"
---
...
- [Primitive Geometries](/components/category_primitives) - Box, Sphere, Cylinder, Cone, Capsule, Plane, Circle, Ring, Torus, TorusKnot, Dodecahedron, Icosahedron, Octahedron, Tetrahedron
...
- [Text](/source/../components/text)
- [Text3D](/source/../components/text3d)
- [Billboard](/source/../components/billboard)

## Background Components

- [SceneBackground](/source/../components/scene_background)
- [ImageBackground](/source/../components/image_background)

## Organization Components

- [Group](/source/../components/group)
- [Pivot](/source/../components/pivot)
- [Center](/source/../components/center)

## Next Steps

- Learn about [Materials and Textures](/guides/first_3d_scene/02_materials_and_textures) to make your components look realistic
- Explore [Camera Control](/guides/first_3d_scene/03_camera_control) for better viewpoints
- Add [Lights](/guides/first_3d_scene/04_lights) to illuminate your scene
