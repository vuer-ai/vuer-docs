---
title: "SceneStore - Reactive Scene Graph Management"
section: "Python API"
order: 100
description: "SceneStore - Reactive Scene Graph Management — Vuer documentation"
---
...
<a id="subscribesession-vuersession--gt-subscriptioncontext" />
...
<a id="get_nodekey-str--gt-optionalscenenode" />
...
- [vuer.rtc - CRDT Data Store](/rtc/README)
- [VuerSession API](/guides/session_apis)
