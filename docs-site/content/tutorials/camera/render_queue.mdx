---
title: "Collecting Renders from Multiple Browser Sessions"
section: "Tutorials"
order: 117
description: "Collecting Renders from Multiple Browser Sessions — Vuer documentation"
---
...
This tutorial builds on [Collecting Renders from a Virtual Camera](/tutorials/camera/grab_render_virtual_camera) and shows you how to scale up render collection using a job queue with multiple browser sessions.
