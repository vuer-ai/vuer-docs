---
title: "Replaying Camera Movements"
section: "Tutorials"
order: 115
description: "Replaying Camera Movements — Vuer documentation"
---

# Replaying Camera Movements

This tutorial shows you how to programmatically control the camera using previously recorded camera movements. This is the companion tutorial to [Recording Camera Movements](/tutorials/camera/record_camera_movement).
