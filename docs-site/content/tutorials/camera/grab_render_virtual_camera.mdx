---
title: "Collecting Renders from a Virtual Camera"
section: "Tutorials"
order: 114
description: "Collecting Renders from a Virtual Camera — Vuer documentation"
---
...
<DocImage src="/source/tutorials/camera/figures/grab_render_virtual_camera.png" alt="grab_render_virtual_camera" />

This tutorial builds on [Replaying Camera Movements](/tutorials/camera/move_camera) and shows you how to programmatically capture rendered frames from a virtual camera.
...
**Prerequisites:** Run the [Recording Camera Movements](/tutorials/camera/record_camera_movement) tutorial first to generate the `assets/camera_movement.pkl` file.
...
<Callout>
  **Depth Rendering**
  ...
  Set `renderDepth=True` to also capture depth maps. The depth data will be available in the `depthFrame` field of the response.
</Callout>
