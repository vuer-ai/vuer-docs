---
title: "Setting Up TLS for WebXR"
section: "Tutorials"
order: 109
description: "Setting Up TLS for WebXR — Vuer documentation"
---
...
| ------------------------------------------------------------- | ----------------------------- | ---------- | ------------------- |
| [Self-signed certificate](/tutorials/basics/self_signed_cert) | Local development, LAN access | Low        | Free                |
| [ngrok](/tutorials/basics/ngrok_setup)                        | Quick setup, internet access  | Low        | Free tier available |
| [localtunnel](/tutorials/basics/localtunnel_setup)            | Free internet access          | Low        | Free                |
| nginx reverse proxy                                           | Advanced setups               | Medium     | Free                |

<Callout>
  **Recommended for Beginners**

  - **VR headset on the same WiFi network as your computer?** → Use [self-signed certificates](/tutorials/basics/self_signed_cert)
  - **VR headset on a different network or need to share with others?** → Use [ngrok](/tutorials/basics/ngrok_setup)
  - **Don't want to pay for ngrok?** → Use [localtunnel](/tutorials/basics/localtunnel_setup) (completely free alternative)
</Callout>
...
See the [self-signed certificate setup guide](/tutorials/basics/self_signed_cert) for complete instructions.
...
See the [ngrok setup guide](/tutorials/basics/ngrok_setup) for complete instructions.
...
See the [localtunnel setup guide](/tutorials/basics/localtunnel_setup) for complete instructions.
