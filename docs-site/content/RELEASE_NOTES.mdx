...
section: "Reference"
order: 12
description: "Release Notes — Vuer documentation"
---

# Release Notes

Browse [individual release entries](/releases). This combined page remains available for existing links and bookmarks.

For versions through v0.0.30, see [Older Release History](/CHANGE_LOG).

<a id="v015---modelnode-base-class-amp-bvh-support" />
...
<a id="v0080rc4---dynamic-links-amp-scene-refactor" />
...
<a id="v0080rc2---workspace-link-api-amp-image-encoders" />
...
<a id="v0080rc1---workspace-multi-path-amp-provider-pattern" />
