---
title: "Showing 360 Views via A Textured Sphere"
section: "Examples"
order: 66
description: "Showing 360 Views via A Textured Sphere — Vuer documentation"
---
...
<DocImage src="/source/examples/figures/farm_house.jpg" alt="equirectangular image" />
...
Here is the expected result: <DocImage src="/source/examples/figures/17_sky_ball.png" alt="sky ball result" />
