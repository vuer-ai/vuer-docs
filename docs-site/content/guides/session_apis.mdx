---
title: "Session APIs - Managing Your Scene"
section: "Guides"
order: 97
description: "Session APIs - Managing Your Scene — Vuer documentation"
---
...
- [Constructing a Scene](/guides/first_3d_scene/01_constructing_a_scene) - Learn about scene structure
- [Event Handling](/api/events) - Responding to user interactions
- [Client Connection](/guides/client_connection) - Connecting Python clients to Vuer
