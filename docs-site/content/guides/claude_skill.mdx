---
title: "Using Vuer with Claude Code"
section: "Guides"
order: 87
description: "Using Vuer with Claude Code — Vuer documentation"
---
...
- Common events: CAMERA\_MOVE, HAND\_MOVE, OBJECT\_MOVE, CLICK
