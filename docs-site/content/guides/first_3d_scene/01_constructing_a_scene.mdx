---
title: "1. Build A Scene in Python"
section: "Guides"
order: 90
description: "1. Build A Scene in Python — Vuer documentation"
---

import { DocImage, SceneEmbed } from '@docs/components/Docs'
...
<DocImage src="/source/guides/figures/simple_box.png" alt="Simple Box" />
...
<DocImage src="/source/_static/01_vuer_architecture.svg" alt="Vuer Architecture" />
...
- [Materials and Textures](/guides/first_3d_scene/02_materials_and_textures) - Making objects look good
- [Camera Control](/guides/first_3d_scene/03_camera_control) - Viewing your scene
- [Lights](/guides/first_3d_scene/04_lights) - Illuminating your world

## Worked example

For a complete scene with a movable box and spotlight, follow [the interactive scene walkthrough](/tutorials/basics/setting_a_scene).
