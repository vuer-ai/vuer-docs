---
title: "2. Materials and Textures"
section: "Guides"
order: 91
description: "2. Materials and Textures — Vuer documentation"
---
...
- Learn about [Camera Control](/guides/first_3d_scene/03_camera_control) to view your scenes from different angles
- Add [Lights](/guides/first_3d_scene/04_lights) to see how they interact with different material types
- Explore advanced rendering with [Render Modes](/guides/first_3d_scene/05_render_modes)
