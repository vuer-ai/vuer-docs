...
section: "Guides"
order: 95
description: "Post-processing — Vuer documentation"
---
...
<DocImage src="/source/_static/06_post_processing_scene.png" alt="Post-Processing Scene" />
...
- [Path Tracing Renders](/guides/first_3d_scene/05_render_modes/path_tracing) - Achieve photorealistic rendering with accurate light simulation
- [Materials and Textures](/guides/first_3d_scene/02_materials_and_textures) - Create materials that work well with post-processing
- [Lighting](/guides/first_3d_scene/04_lights) - Set up lighting to maximize bloom and HDR effects
