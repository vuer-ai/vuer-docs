---
title: "5. Render Modes"
section: "Guides"
order: 96
description: "5. Render Modes — Vuer documentation"
---
...
- **[Post-processing](/guides/first_3d_scene/05_render_modes/post_processing)** - Add bloom effects and visual polish with screen-space post-processing
- **[Path Tracing Renders](/guides/first_3d_scene/05_render_modes/path_tracing)** - Create photorealistic renders with accurate global illumination
...
| ---------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| <DocImage src="/source/_static/01_rgb_scene.png" width={250} height={200} style={{"objectFit":"cover"}} /> | <DocImage src="/source/_static/06_post_processing_scene.png" width={250} height={200} style={{"objectFit":"cover"}} /> | <DocImage src="/source/_static/07_path_tracing_scene.png" width={250} height={200} style={{"objectFit":"cover"}} /> |
...
- [Materials and Textures](/guides/first_3d_scene/02_materials_and_textures) - Materials affect how different render modes display your scene
- [Lighting](/guides/first_3d_scene/04_lights) - Lighting setup is crucial for both post-processing and path tracing
