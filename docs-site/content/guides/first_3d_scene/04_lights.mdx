...
section: "Guides"
order: 93
description: "4. Lights — Vuer documentation"
---
...
- [Render Modes](/guides/first_3d_scene/05_render_modes) - Learn about different rendering modes

  - [Post-processing Effects](/guides/first_3d_scene/05_render_modes/post_processing) - Add bloom and other effects
  - [Path Tracing](/guides/first_3d_scene/05_render_modes/path_tracing) - Create photorealistic renders

**Explore interactive features:**

- [Animation](/guides/session_apis) - Animate objects and cameras
- [Events and Interaction](/guides/session_apis) - Handle user clicks and input
- [VR/AR](/examples/vr_xr/hand_tracking) - Build immersive experiences
