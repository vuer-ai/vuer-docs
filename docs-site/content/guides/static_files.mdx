---
title: "Static File Serving & Hot Loading"
section: "Guides"
order: 98
description: "Static File Serving & Hot Loading — Vuer documentation"
---

import { Callout } from '@docs/components/Docs'

<a id="static-file-serving-amp-hot-loading" />
...
- [Session APIs](/guides/session_apis) - Managing scene updates
- [Loading 3D Models](/examples/meshes) - Examples of loading different formats
- [Component Index](/components/category_3d_models) - All available 3D model components
