---
title: "Connecting a Python Client to Vuer"
section: "Guides"
order: 89
description: "Connecting a Python Client to Vuer — Vuer documentation"
---
...
**[server.py](http://server.py)** - Runs the Vuer server:
...
**[client.py](http://client.py)** - Sends animated position updates with a custom event class:
