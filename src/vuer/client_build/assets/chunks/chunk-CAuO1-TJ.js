import{r as e,j as P}from"./chunk-BsAOyGYT.js";import{f as se,h as ue,i as o,j as ce,k as pe,m as Q,l as fe,n as Z,M as I,o as de,p as H,q as J,r as b,s as D,t as me,v as ve,Q as xe}from"./chunk-Dxx5dVLh.js";import"./chunk-tuBEHo31.js";/* empty css              */import"./chunk-BXl3LOEh.js";const Me=3;function ye({matrices:a,count:d,color:n,ringSize:u=.05,innerAlpha:l=.02,outerAlpha:f=.3,clip:i}){const t=e.useRef(null),m=e.useMemo(()=>new me(1,32),[]),r=e.useMemo(()=>new J({uniforms:{uColor:{value:new D(n)},ringSize:{value:u},innerAlpha:{value:l},outerAlpha:{value:f},clipEnabled:{value:!1},clipMin:{value:new b(-5,-5,-5)},clipMax:{value:new b(5,5,5)}},vertexShader:`
        varying vec2 vUv;
